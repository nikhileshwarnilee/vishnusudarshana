...
<div class="blog-detail-container">
    ...
    <div class="share-section">
        ...
        <div class="share-buttons">
            ...
            <a href="https://twitter.com/intent/tweet?url=<?= urlencode($shareUrl) ?>&text=<?= urlencode($blogTwitterText) ?>" target="_blank" class="share-btn twitter">
            ...
            <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?= urlencode($shareUrl) ?>&title=<?= urlencode($shareTitle) ?>" target="_blank" class="share-btn linkedin">
